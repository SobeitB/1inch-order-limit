...
export const GET_TOKENS = `https://api.1inch.io/v5.0/${chainIdString}/tokens`;
...
export const GET_NEW_ORDER = async (order:string) => {
   return `https://limit-orders.1inch.io/v2.0/${CHAIN_ID}/limit-order/events/${order}`;
}
